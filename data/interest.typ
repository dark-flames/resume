...
#let interest(env) = {
  ...
  cv-content(env, {
    ...
    [
      ...
      - _Semantic models of type theories_, especially categorical semantics, leverage categorical perspectives to grasp the essence of new language features quickly.
